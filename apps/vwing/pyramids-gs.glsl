...
main() {
  ...
  uint i0 = texelFetch(index, 5 * v_id[0]    ).r;
  uint i1 = texelFetch(index, 5 * v_id[0] + 1).r;
  uint i2 = texelFetch(index, 5 * v_id[0] + 2).r;
  uint i3 = texelFetch(index, 5 * v_id[0] + 3).r;
  uint i4 = texelFetch(index, 5 * v_id[0] + 4).r;
  ...
  make_triangle( x0 , x1 , x4 , 1 , 1 , 1 );
  make_triangle( x1 , x2 , x4 , 1 , 1 , 1 );
  make_triangle( x2 , x3 , x4 , 1 , 1 , 1 );
  make_triangle( x3 , x0 , x4 , 1 , 1 , 1 );

  make_triangle( x0 , x2 , x1 , 1 , 1 , 0 );
  make_triangle( x0 , x3 , x2 , 1 , 0 , 1 );
}
